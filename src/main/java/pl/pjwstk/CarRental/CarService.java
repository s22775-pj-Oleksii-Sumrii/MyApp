...
public class CarService {
    ...
    private static final int ONEDAY = 50;
            ...
            if (!taken) {
                ...
                if (carStorage.findByVin(vin).getKlasa().equals("standard")) {
                    System.out.println("wynajęty samochód: \n" + carStorage.findByVin(vin).toString() + "\n" + "Cena " +
                            "samochodu: " + (ONEDAY * numberOfDays * STANDARD));
                    price = ONEDAY * numberOfDays * STANDARD;
                } else if (carStorage.findByVin(vin).getKlasa().equals("premium")) {
                    System.out.println("wynajęty samochód: \n" + carStorage.findByVin(vin).toString() + "\n" + "Cena " +
                            "samochodu: " + (ONEDAY * numberOfDays * PREMIUM));
                    price = ONEDAY * numberOfDays * PREMIUM;
                }
                System.out.println();
            }
